...
The front-end application written in \gls{typescript} with \glsi{ng2}.
The \gls{ui} layer is provided by the \glsi{nativescript} framework and configured to compile to both \textit{Android} and \textit{iOS} operation systems.
For communications the library \glsi{apollo:client} is used to comply with \glsi{graphql}.
