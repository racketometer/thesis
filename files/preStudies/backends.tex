...
There are integration guides for \textit{Angular 2}, \textit{Redux}, \textit{Meteor}, \textit{React} and \textit{React native}, but one should be able to integrate it into any JavaScript front-end.
