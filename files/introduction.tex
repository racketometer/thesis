...
\section*{Roadmap}
In planning what we can achieve during this project, a roadmap was created with
milestones and dates. The roadmap focuses on the progress of the application
during the project. The roadmap will be used during SCRUM planning and might
change over the duration of the project. See the roadmap in figure \ref{fig:introduction:roadmap}.
