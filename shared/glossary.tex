...
\newglossaryentry{reactnative}{
    name = {React Native},
    description = {A cross-platform framework for building mobile applications}
}
...
\newglossaryentry{scrum:board}{
    name = {scrum board},
    description = {A board consisting of columns named after task states. Tasks move from left to right over the board and visualize the progress of the current sprint}
}
...
\newglossaryentry{ddp}{
    ...
    description = {A client-server protocol based on the publish-subscribe messaging pattern to synchronize changes to the back-end database with clients}
}
...
\newglossaryentry{github}{
    name = {GitHub},
    description = {An online platform for software collaboration through \textit{Git} version control}
}
...
\newglossaryentry{mlab}{
    name = {mLab},
    description = {A Database-as-a-Service provider for \glsi{mongodb}}
}

\newglossaryentry{travis}{
    name = {Travis CI},
    description = {Continuous integration server as a service for testing and deploying applications}
}
...
\newglossaryentry{repl}{
    name = {REPL},
    description = {Execution environment based on ''read-eval-print loop'' pattern to execute code instantaneous}
}
...
\newglossaryentry{mongoose}{
    name = {Mongoose},
    description = {A \glsi{mongodb} \gls{orm}}
}

\newglossaryentry{istanbul}{
    name = {Istanbul},
    description = {Coverage tool for JavaScript}
}

\newglossaryentry{coveralls}{
    name = {Coveralls},
    description = {Code coverage visualization service}
}

\newglossaryentry{sinon}{
    name = {Sinon.JS},
...
\newglossaryentry{mocha}{
    name = {Mocha},
    description = {Test runner for \glsi{node}}
}

\newglossaryentry{chai}{
    name = {Chai},
    description = {Assertion library for \glsi{node}}
}

\newglossaryentry{ci}{
    name = {Continuous Integration},
    description = {The process of continually building and testing source code on every commit}
}

\newglossaryentry{tls}{
    name = {TLS},
    description = {Transport Layer Security, the successor to SSL (Secure Sockets Layer), is an encryption layer on the \gls{http} protocol}
}

\newglossaryentry{moqups}{
    name = {Moqups},
    description = {Online design platform for drawing prototypes and mock-ups}
}
