...
\newglossaryentry{coveralls}{
    name = {Coveralls},
    description = {Coverage visualization service}
}
...
\newglossaryentry{tls}{
    name = {TLS},
    description = {Transport Layer Security, the successor to SSL (Secure Sockets Layer), is a encryption layer on the \gls{http} protocol.}
}
