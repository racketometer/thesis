...
\textbf{Description:}
\\
\glsi{nativescript} uses a JavaScript toolchain to compile the JavaScript code into the native \gls{api}.
...
\glsi{nativescript} fulfills most of our requirements out of the box.
