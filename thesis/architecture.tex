...
On the back-end the application layer is an \glsi{apollo:server} instance.
This is the counter part to the \glsi{apollo:client} and provides the reactive data system.
It further defines the \gls{api} for collecting data from databases like \glsi{mongodb}, as this project utilizes.
...
The \verb+template+, specifically in \glsi{nativescript}, is written in a language similar to \gls{xml} and represents how a component should be rendered in the \gls{ui}.
