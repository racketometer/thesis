...
The back-end codebase is deployed to a \glsi{heroku} infrastructure running \glsi{node} and set up with environment variables, see section \ref{sec:staging}, to communicate with a \glsi{mongodb} instance hosted on \glsi{mlab}.

\graphic{0.9}{deployment}{Software deployment model}{deploymentmodel}
